...
def main():
    ...
    if values:
        ...
        chart = alt.Chart(df).mark_area(
            ...
            tooltip=["Index:Q", "Integer:Q", alt.Tooltip("Normalized:Q", format=".6f")],
        ...
        df_display = df.copy()
        df_display["Integer"] = df_display["Integer"].astype(str)
        df_display["Normalized"] = df_display["Normalized"].map(lambda value: f"{value:.10f}")
